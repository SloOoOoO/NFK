...
namespace NFK.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260307204555_AddAssistantAssignmentAndReceptionistToggle")]
    partial class AddAssistantAssignmentAndReceptionistToggle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NFK.Domain.Entities.Users.AssistantAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NFK.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.Property<string>("FirmChamberRegistration")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FirmLegalName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FirmPostalCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FirmTaxId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NFK.Domain.Entities.Users.AssistantAssignment", b =>
                {
                    b.HasOne("NFK.Domain.Entities.Users.User", "AssistantUser")
                        .WithMany()

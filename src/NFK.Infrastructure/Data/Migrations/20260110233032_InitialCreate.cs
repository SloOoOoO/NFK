        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DATEVId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Users_ConsultantUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DATEVJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DATEVJobs_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DATEVJobId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DATEVJobFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DATEVJobFiles_DATEVJobs_DATEVJobId",
                        column: x => x.DATEVJobId,
                        principalTable: "DATEVJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DATEVLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DATEVLogs_DATEVJobs_DATEVJobId",
                        column: x => x.DATEVJobId,
                        principalTable: "DATEVJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChecksumHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ConsultantUserId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DATEVJobFiles_DATEVJobId",
                table: "DATEVJobFiles",
                column: "DATEVJobId");

            migrationBuilder.CreateIndex(
                name: "IX_DATEVJobs_ClientId",
                table: "DATEVJobs",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_DATEVLogs_DATEVJobId",
                table: "DATEVLogs",
                column: "DATEVJobId");

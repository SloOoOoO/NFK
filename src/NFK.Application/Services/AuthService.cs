...
public class AuthService : IAuthService
{
    ...
    public async Task<UserResponse> GetUserByIdAsync(int userId)
    {
        ...
        return new UserResponse(
            ...
            user.FirstName,
            user.LastName,
            _encryption.SafeDecrypt(user.PhoneNumber),
            role,
            user.IsActive,
            _encryption.SafeDecrypt(user.FullLegalName),
            user.DateOfBirth,
            _encryption.SafeDecrypt(user.Address),
            _encryption.SafeDecrypt(user.City),
            _encryption.SafeDecrypt(user.PostalCode),
            user.Country,
            _encryption.SafeDecrypt(user.TaxId),
            _encryption.SafeDecrypt(user.TaxNumber),
            _encryption.SafeDecrypt(user.VatId),
            _encryption.SafeDecrypt(user.CommercialRegister),
            user.ClientType,
            user.CompanyName,
            user.Salutation,
            user.Gender,

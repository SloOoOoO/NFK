          ...
          <div className="mb-8">
            <div className="space-y-3">
              ...
              <button
                ...
                type="button"
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors bg-white dark:bg-gray-800"
                disabled={loading}
              >
                ...
                <span className="text-gray-900 dark:text-gray-100">Mit Google registrieren</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-900 dark:text-gray-100">Mit DATEV registrieren</span>
              </button>
            </div>
            ...
            <div className="my-6 flex items-center">
              ...
              <span className="px-4 text-sm text-gray-500 dark:text-gray-400">oder mit E-Mail registrieren</span>
              <div className="flex-1 border-t border-gray-300 dark:border-gray-600"></div>
            </div>
          </div>
